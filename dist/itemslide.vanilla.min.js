    ...
    function slideout(slides, settings, vars) {
        ...
        function swipeOutAnimation() {
            ...
            if (enableOpacity) {
                ...
                slides.savedSlide.css("opacity", savedOpacity - _this._easeOutBack(currentTime, 0, savedOpacity - 0, 250, 0) * (goback ? -1 : 1)); //Can try to remove opacity when animating width
